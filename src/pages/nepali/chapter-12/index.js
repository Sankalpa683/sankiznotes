...
function helloworld() {
  return (
    <div>
        <Head>
            <title>Unit-12 जीवन मार्ग  | MozeeeNotes</title>
        </Head>
        <Nav/>
        <br></br><br></br><br></br>
        <div class="container mx-auto px-5 py-5">
          ...
          <nav class="flex" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
              ...
              <li aria-current="page">
                <div class="flex items-center">
                  ...
                  <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">जीवन-मार्ग</span>
                </div>
              </li>
            </ol>
          </nav>
            ...
            <div className='heaading_text'>
                <h1 class={styles.heading}>Chapter-12 जीवन मार्ग - Nepali </h1>
            </div>
