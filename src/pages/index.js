...
<section class="bg-center bg-no-repeat bg-[url('https://www.phonexia.com/wp-content/uploads/top-machine-learning-conferences-2023.jpg')] bg-gray-700 bg-blend-multiply">
    <div class="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56">
        ...
        <div class="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0">
            ...
            <Link href="/contact" class="inline-flex justify-center hover:text-gray-900 items-center py-3 px-5 sm:ms-4 text-base font-medium text-center text-white rounded-lg border border-white hover:bg-gray-100 focus:ring-4 focus:ring-gray-400">
                Contact Us
            </Link>  
        </div>
    </div>
    ...
    <div className="min-h-screen flex justify-center items-center bg-gray-100">
      <div className="bg-white p-8 rounded-lg shadow-lg">
        <h1 className="text-3xl font-bold mb-4">Hurry up! Study Hard</h1>
        <p className="text-xl mb-4">Class 12th NEB Exam is within</p>
