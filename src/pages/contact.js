...
const haha = () => {
  return (
    <div>
      ...
      <img src='/contact.png' style={{width : '100%'}}></img>
      <br></br><hr></hr>
      <div className={styles.contact} style={{marginTop : '2.5rem'}}>
        <div className={styles.contact_first}>
          <h1>Hello World!</h1>
          <p>In order to contact, you can mail us at our email listed below</p>
        </div>
        <div className={styles.contact_second}>
          {/* <h1>Contact</h1> */}
