  ...
  return (
    ...
    <br></br><br></br><br></br>
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
              ...
              <li aria-current="page">
                <div class="flex items-center">
                  ...
                  <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">issue-of-share-for-cash</span>
                </div>
              </li>
            </ol>
          </nav>
        ...
        <div className='heaading_text'>
                <h1>Issue of Share for Other Than Cash - Class 12 Account</h1>
            </div>
            <br></br>
        <div class='pl-3 container mx-auto px-5' id='embeds'>
        <iframe src="https://drive.google.com/file/d/1yg3JAHG-7GkRbxuLBAcwdfCKb6inSOVC/preview" width="100%" height="780"></iframe>
        </div>
