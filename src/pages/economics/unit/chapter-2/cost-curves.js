    ...
    <div>
        ...
        <div class="container mx-auto px-5 py-5">
          ...
          <nav class="flex" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
              ...
              <li aria-current="page">
                <div class="flex items-center">
                  ...
                  <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">cost-curves</span>
                </div>
              </li>
            </ol>
          </nav>
            ...
            <iframe src="https://drive.google.com/file/d/1CCIh9TCUFN6ALCTxrAbjOPxsCct1Y0In/preview" width="100%" height="780" allow="autoplay"></iframe>
            </div>
        </div><br></br><br></br>
        <div>
