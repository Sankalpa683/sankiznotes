...
function helloworld() {
  return (
    <div>
        <Head>
            <title>Unit-8 Constitution and Civic Awareness Notes | MozeeeNotes</title>
        </Head>
        <Nav/>
        <br></br><br></br><br></br>
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
              ...
              <li aria-current="page">
                <div class="flex items-center">
                  ...
                  <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">संविधान-र-नागरिक-सचेतना</span>
                </div>
              </li>
            </ol>
          </nav>
